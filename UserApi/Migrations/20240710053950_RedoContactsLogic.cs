...
{
    /// <inheritdoc />
    public partial class RedoContactsLogic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactRequests", x => new { x.UserSenderId, x.UserReceiverId });
                    table.ForeignKey(
                        name: "FK_ContactRequests_Users_UserReceiverId",
                        column: x => x.UserReceiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactRequests_Users_UserSenderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_UserReceiverId",
